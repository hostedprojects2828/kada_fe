    ...
    <>
      <div className='col-lg-3'>
        <div className='d-flex justify-content-between d-sm-none '>
          <div className='all-product-header mb-2'></div>
            ...
            <div className='shop_sidebar_boxed'>
              ...
              <div className='product-variable-color'>
                <label htmlFor='modal-product-color-red6'>
                  <input name='modal-product-color' id='modal-product-color-red6' className='color-select' type='radio' />
                  <span className='product-color-red'></span>
                </label>
                <label htmlFor='modal-product-color-tomato1'>
                  <input name='modal-product-color' id='modal-product-color-tomato1' className='color-select' type='radio' />
                  <span className='product-color-tomato'></span>
                </label>
                <label htmlFor='modal-product-color-green2'>
                  <input name='modal-product-color' id='modal-product-color-green2' className='color-select' type='radio' defaultChecked />
                  <span className='product-color-green'></span>
                </label>
                <label htmlFor='modal-product-color-light-green3'>
                  <input name='modal-product-color' id='modal-product-color-light-green3' className='color-select' type='radio' />
                  <span className='product-color-light-green'></span>
                </label>
                <label htmlFor='modal-product-color-blue4'>
                  <input name='modal-product-color' id='modal-product-color-blue4' className='color-select' type='radio' />
                  <span className='product-color-blue'></span>
                </label>
                <label htmlFor='modal-product-color-light-blue5'>
                  <input name='modal-product-color' id='modal-product-color-light-blue5' className='color-select' type='radio' />
