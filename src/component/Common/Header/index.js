...
const Header = () => {
  ...
  const isSticky = e => {
    ...
    scrollTop >= 250 && header.classList.add('is-sticky');
    scrollTop < 250 && header && header.classList.remove('is-sticky');
  };
                  ...
                  <ul className='header-action-link action-color--black action-hover-color--golden'>
                    ...
                    <li>
                      ...
                      {carts.length ? (
                        ...
                        <a href='#!' className='offcanvas-toggle letter-space'>
                          <i className='fa fa-shopping-bag'></i>
                          <span className='item-count'>{carts.length}</span>
                        </a>
                      )}
                    ...
                    <>
                      <ul className='mobile-sub-menu'>
                        <li>
                          ...
                          <ul className='mobile-sub-menu'>
                            ...
                            <li>
                              <Link to='/shop-right-bar'>Shop Right Sidebar</Link>
                            </li>
                          </ul>
                        </li>
                      </ul>
                      ...
                      <ul className='mobile-sub-menu'>
                        <li>
                          ...
                          <ul className='mobile-sub-menu'>
                            <li>
                              <Link to='/product-details-one/1'>Product Single</Link>
                            </li>
                            <li>
                              <Link to='/product-details-two/1'>Product Single Two</Link>
                            </li>
                          </ul>
                        </li>
                      </ul>
      ...
      <div id='offcanvas-add-cart' className='offcanvas offcanvas-rightside offcanvas-add-cart-section'>
        ...
        <div className='offcanvas-add-cart-wrapper'>
            ...
            {carts.map((data, index) => (
              <li className='offcanvas-wishlist-item-single' key={index}>
                ...
                <div className='offcanvas-wishlist-item-delete text-right'>
                  <a href='#!' className='offcanvas-wishlist-item-delete' onClick={() => rmCartProduct(data.id)}>
          ...
          <ul className='offcanvas-cart-action-button'>
            <li>
              <Link to='/cartThree' className='theme-btn-one btn-black-overlay btn_md'>
                View Cart
              </Link>
            </li>
            <li>
              <Link to='/checkout-one' className='theme-btn-one btn-black-overlay btn_md'>
                Checkout
              </Link>
            </li>
          </ul>
          ...
          <ul className='offcanvas-wishlist'>
            {favorites.map((data, index) => (
              <li className='offcanvas-wishlist-item-single' key={index}>
                ...
                <div className='offcanvas-wishlist-item-delete text-right'>
                  <a href='#!' className='offcanvas-wishlist-item-delete' onClick={() => rmFavProduct(data.id)}>
                    <i className='fa fa-trash'></i>
                  </a>
                </div>
              </li>
