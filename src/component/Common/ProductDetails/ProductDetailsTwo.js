...
const ProductDetailsTwo = () => {
  ...
  return (
    <>
      {product ? (
        <section id='product_single_two' className='pt-5'>
              ...
              <div className='col-lg-8 col-md-8'>
                <div className='product_details_right_one'>
                  <div className='modal_product_content_one'>
                    ...
                    <h4>
                      ${product.price}.00 <del>${parseInt(product.price) + 17}.00</del>{' '}
                    </h4>
                    ...
                    <div className='links_Product_areas'>
                      {cart.some((item) => item.id == id) ? (
                        <Link to='/cartThree' className='theme-btn-one btn-black-overlay btn_sm'>
                          View Cart
                        </Link>
                      ) : (
                        <a
                      ...
                      <Link to='/checkout-one' className='theme-btn-one btn-black-overlay btn_sm ml-2'>
                        Buy Now
                      </Link>
                    </div>
                  </div>
