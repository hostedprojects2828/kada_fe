...
const CustomerAddressEdit = loadable(() => pMinDelay(import('./page/my-account/Customer-address-eidt'), 250), { fallback: <Loading /> });
      ...
      <BrowserRouter>
        <Router>
          ...
          <Switch>
            ...
            <Route path='/my-account/customer-address-edits/:id' exact component={CustomerAddressEdit} />
